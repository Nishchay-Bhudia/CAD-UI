// ============================================================
// AeroForge CAD — Zustand State Store
// ============================================================
...
export const useStore = create(
  immer((set, get) => ({
    ...
    // ── Viewport State ───────────────────────────────────
    viewMode: 'shaded-edges',   // shaded | shaded-edges | wireframe | xray | hidden-line
    cameraPreset: 'iso',        // front|top|right|iso
    showGrid: true,
    showAxes: true,
    ...
    showShadows: true,
    showAO: false,
    background: 'gradient',    // gradient|solid|hdri
    showMeasure: false,
    ...
    // ── Panels ───────────────────────────────────────────
    activeRightPanel: 'properties',  // properties|materials|analysis|bom|drawing
    leftPanelWidth: 260,
    rightPanelWidth: 300,

    // ── Analysis State ───────────────────────────────────
    analysisMode: null,   // vlm|fea|propulsion|orbital|performance|mass
    analysisResults: {},
    ...
    // ── Dialogs / Modals ─────────────────────────────────
    activeDialog: null,  // shortcut-overlay|export|import|component-lib|new-model|settings|bom
    dialogData: null,
    ...
    loadModel: (model) => set(s => {
      s.features = model.features || []; s.modelName = model.name; s.modelId = model.id
